  ...
  return (
    <div id="t2" className="hidden-box">
      <div className=" bakhsh-2 ">
        ...
        <div className="text-welcome">واحد PSC</div>
        <div className="container-text-Education">
          <div className="Education-text">
            یک شاخص عرضه و تبادل محصولات داخلی شما به جهت عدم خارج کردن ارز از
            متاورس رنگ
          </div>
          <div className="page-box-color ">
            جهت فروش محصولات خود شما میتوانید با واحد پی اس سی موجود در این
            دنیای مجازی اقدام از خدمات این واحد بهرمند شوید <br />
            <br />
            واحد پی اس سی یک وزنه تعادل در عرضه و تقاضای داخلی میباشد و در گام 2
            متاورس رنگ به یک ارز دیجیتال تبدیل خواهد شد
          </div>
        </div>
