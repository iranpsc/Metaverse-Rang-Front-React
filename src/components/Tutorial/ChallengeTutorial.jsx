...
export default function ChallengeTutorial({ nextPageHandler }) {
  return (
    <div id="t16" className="hidden-box-13">
      ...
      <div className="bakhsh-9">
        ...
        <div className="text-welcome">چالش ها</div>
        <div className="container-text-Education">
          <div className="Education-text">
            جوایز متعدد در VOD مختلف متناسب با رده های سنی
          </div>
          <div className="page-box-color ">
            با شرکت در چالش ها اطلاعت خود در باره جهان متاورس را افزایش داده و
            با ارایه پاسخ هدایای نفیسی به دست آورید
          </div>
        </div>
      ...
      <div className="class-arrows-5"></div>
    </div>
  );
}
