  ...
  return (
    <div id="t8" className="hidden-box-4">
      <div className="bakhsh-7">
        ...
        <div className="text-welcome">تقویم</div>
        <div className="container-text-Education">
          ...
          <div className="page-box-color ">
            نمایش فاز های اجرایی پروژه متاورس رنگ را میتوانید از بخش تقویم
            مشاهده کنید
            <br />
            <br />
            زمانبندی و هدف دهی ساختار های نمایش . توسعه و بروزرسانی ها در بخش
            تقویم نمایش داده میشود
          </div>
        </div>
