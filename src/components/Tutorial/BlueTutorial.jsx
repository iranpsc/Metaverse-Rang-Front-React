  ...
  return (
    <div id="t4" className="hidden-box-2">
      <div className=" bakhsh-3 ">
        ...
        <div className="text-welcome">رنگ آبی</div>
        <div className="container-text-Education">
          <div className="Education-text">
            یک شاخص داخلی برای خرید VOD مجازی کاربری مراکز آموزشی است
          </div>
          <div className="page-box-color ">
            رنگ آبی شاخص خرید VOD های موجود در بافت خدماتی میباشد
            <br />
            <br />
            VOD هایی که توسط سرور برای عرضه آزاد میشود در صورتی که به رنگ آبی
            باشد شما میتوانید با این موجودی صاحب ملک مجازی شوید
          </div>
        </div>
