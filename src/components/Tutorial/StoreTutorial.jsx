  ...
  return (
    <div id="t9" className="hidden-box-5">
      <div className="bakhsh-7">
        ...
        <div className="text-welcome">فروشگاه</div>
        <div className="container-text-Education">
          <div className="Education-text">لیست لوازم و محصولات قابل عرضه</div>
          <div className="page-box-color ">
            فروشگاه متاورس رنگ ارز های داخلی و نیز ابزار های خاص را برای عرضه
            لیست میکند
            <br />
            <br />
            قابلیت خرید محصولات با درگاه های ایرانی امکان پذیر است و بزودی به
            بلاکچین ایرانی و ارز دیجیتال متصل میشود
          </div>
        </div>
