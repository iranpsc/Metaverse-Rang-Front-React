  ...
  return (
    <div id="t3" className="hidden-box-1">
      <div className="bakhsh-2">
        ...
        <div className="text-welcome">ارز دیجیتال ریال</div>
        <div className="container-text-Education">
          <div className="Education-text">
            یک شاخص عرضه و تبادل محصولات داخلی شما به جهت خارج کردن ارز از
            متاورس رنگ
          </div>
          <div className="page-box-color ">
            جهت فروش محصولات خود میتوانید با ارز هایی که خارج از این دنیای مجازی
            قابل عرضه است اقدام به قیمت گذاری محصولات کنید
            <br />
            <br />
            محصولات شما میتواند به سادگی با تبادل و فروش مستقیم در چرخه اختصادی
