  ...
  return (
    <div id="t10" className="hidden-box-6">
      <div className="bakhsh-7">
        ...
        <div className="text-welcome">پیام ها</div>
        <div className="container-text-Education">
          <div className="Education-text">
            ارسال پیام و نیز بررسی پیام های ارسال شده
          </div>
          <div className="page-box-color ">
            برای ارسال پیام میتوانید از این گذینه استفده کنید و همچنین پیام های
            ارسال شده توسط بازیکنان دیگر و سرور نیز در این بخش به نمایش گذاشته
            میشود
            <br />
            <br />
