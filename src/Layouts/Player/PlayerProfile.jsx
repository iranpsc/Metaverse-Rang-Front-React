...
function PlayerProfile({ image ,code, level, id, Online }) {
  ...
  return (
    <Container className='white-box-shadow'>
        ...
        <IconContainer>
          <IconSection>
            <img src={ListIcon} alt='' width={34} onClick={() => Navigate(`/metaverse/player/${id}`)}/>
            <img src={ShareIcon} alt='' width={34} className="object-disabled"/>
          </IconSection>

          <IconSection>
            <img src={SanadIcon} alt='' width={34} onClick={() => Navigate('/metaverse/sanad', {state: { code, id }})}/>
            <img src={MessageIcon} alt='' width={34} className="object-disabled"/>
          </IconSection>
        </IconContainer>
