...
export default function SatisfactionTutorial({ nextPageHandler }) {return(
  ...
  <div className=" bakhsh-3 ">
    ...
    <div className="container-text-Education">
      <div className="Education-text">
        یک شاخص داخلی برای توسعه
      </div>
      <div className="page-box-color ">
        رضایت بخشی از هدفی بزرگ است که برای ساخت و ساز و توسعه متاورس رنگ استفاده خواهد شد<br /><br />
        کسب رضایت روش ها و سبک های مختلفی دارد و میتوانید آموزش ها رو مشاهده کنید
      </div>
    </div>
