  ...
  return (
    <div id="t14" className="hidden-box-11">
      ...
      <div className="bakhsh-8">
        ...
        <div className="text-welcome">سود انباشته</div>
        <div className="container-text-Education">
          ...
          <div className="page-box-color ">
            شما میتوانید با شرکت در چالش ها به پاداش های متفاوتی دست یابید که در
            گنجبنه ها مخفی شده اند
            <br />
            <br />
            ما برای شما هدایایی آماده کرده ایم که شما میتوانید با اتمام هر چالش
            به آن دست یابید
          </div>
        </div>
      ...
      <div className="class-arrows-3"></div>
    </div>
  );
}
