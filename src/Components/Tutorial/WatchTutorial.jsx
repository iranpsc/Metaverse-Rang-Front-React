...
export default function WatchTutorial({ nextPageHandler }) {
  ...
  <div className="bakhsh-7">
    ...
    <div className="container-text-Education">
      ...
      <div className="page-box-color ">
        ساعت مرکزی سرور در تمام ایران یکسان است و این شاخص بذای چالش ها و مسابقات در نظر گرفته شده است و شما طبق اطلاعیه میتوانبد سر ساعت مقرر حضور داشته باشد
      </div>
    </div>
  ...
  <div className="class-arrows-2">
  </div>
  <div className="img-circle">
    <div className="tw-box-icons">
      <div className="tw-watch-box">
        12:00:15
      </div>
    </div>
  </div>
