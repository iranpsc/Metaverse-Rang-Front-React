...
<div className="tw-profile-tuto">
  <div className="tw-prifile-tuto-2">
    <div className="tw-profile-level-tuto">
      <div className="tw-profile-text-tuto">
        13
      </div>
    </div>
    <div className="tw-profile-tuto-hm  ">
      HM-9999999
    </div>
    ...
    <div className="tw-icon-left-profile-tuto">
      <div className="tw-size-icon-profile-tuto">
        <img src={TiketIcon} className="tw-icon-left-profile-shadow "  alt=''/>
      </div>
      <div className="tw-size-icon-profile-tuto">
        <img src={ChatIcon} className="tw-icon-left-profile-shadow " alt=''/>
      </div>
      <div className="tw-size-icon-profile-tuto">
        <img src={SettignIcon} className="tw-icon-left-profile-shadow " alt='' />
      </div>
    </div>
    ...
    <div className="tw-certifict-profile-tuto">
      <img src={CertificateIcon} className="tw-certice-shadow-profile" alt=""/>
    </div>
  </div>
</div>
