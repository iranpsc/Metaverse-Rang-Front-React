...
export default function GlobalStatisticsTutorial({nextPageHandler}) {return(
  ...
  <div className=" bakhsh-3 ">
    ...
    <div className="container-text-Education">
      ...
      <div className="page-box-color ">
        جهت فروش محصولات خود شما میتوانید با ارز هایی که خارج از این دنیای مجازی قابل عرضه هست اقدام به قیمت گذاری محصولات کنید 
        <br /><br />
        محصولات شما میتواند یه سادگی با تبادل  و فروش مستقیم در چرخه اقتصادی خارج از متاورس قرار گیرد 
      </div>
    </div>
