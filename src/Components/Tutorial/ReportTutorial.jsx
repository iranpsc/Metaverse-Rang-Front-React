  ...
  <div className="bakhsh-7">
    ...
    <div className="container-text-Education">
      ...
      <div className="page-box-color ">
        این گزینه در تمام صفحات و تمامی بخش ها موجود است و شما میتوانید به سادگی خطاهای موجود در سامانه را اعلام کنیدو در صورتی که خطا ها حائز اهمیت باشد یه شما پاداش تعلق خواهد گرفت
      </div>
    </div>
