      ...
      {status === "confirmed" && (
        <>
          <Info>
            ...
            <p>
              درخواستی جهت ورود به سلسله خانوادگی برای شما از سمت شناسه شهروندی
              [ نام شهروند دریافت کننده ] ارسال گردیده است. خوشبختانه شما این
              درخواست را قبول و شهروندی به عنوان [ نسبت خانوادگی ] در سلسله شما
              اضافه گردیده است.
            </p>
            <p>
            ...
            <p>
              پاداش‌های زیر برای عضویت [ نسبت خانوادگی ] در سلسله میباشد و برای
              دریافت آن میبایست سلسله داشته باشید.
            </p>
          </Info>
          <Wrapper>
            <Subject>
